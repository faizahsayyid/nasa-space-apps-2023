      ...
      <SimpleGrid columns={1} spacing={6}>
        ...
        <FormControl id="email" mt={1}>
          ...
          <Stack
            ...
            <Checkbox><FormHelperText> I give consent to share my contact information with interested users.
  ...
  return (
    <>
      <Box
        ...
        {step === 1 ? <ProjectForm /> : step === 2 ? <ProjectForm2 /> : <ProjectForm3 />}
              ...
              <Button
                ...
                onClick={() => {
                  toast({
                    ...
                    description: "We've created successfully created the project listing!",
                    status: 'success',
                    duration: 3000,
                    isClosable: true,
                  })
